...
flags.DEFINE_integer("batch_size", default=4000, help="Maximum batch size.")
...
flags.DEFINE_integer("epochs", default=1, help="Number of training epochs.")#default=2000
...
result =???
  #跑分  hits_at_1_score = hits_at_1 / examples_count * 100
